...
changeling-transform-others = Тело { CAPITALIZE(THE($user)) } искажается и принимает облик другого существа!
...
changeling-sting-fail-self = Мы пытались ужалить { CAPITALIZE(THE($target)) }, но что-то помешало!
changeling-sting-fail-ling = Кто-то пытался тайно ужалить нас!
changeling-sting = Мы тайно ужалили { CAPITALIZE(THE($target)) }.
...
changeling-voidadapt-lowpressure-start = Мы приспосабливаемся к окружающему низкому давлению.
changeling-voidadapt-lowpressure-end = Окружающее давление больше не является низким. Мы отказываемся от адаптации.
changeling-voidadapt-lowtemperature-start = Мы приспосабливаемся к окружающей нас низкой температуре.
changeling-voidadapt-lowtemperature-end = Температура окружающей среды выше. Мы отказываемся от адаптации.
...
changeling-voidadapt-onfire = Наши адаптации становятся слишком болезненными, чтобы поддерживать их в огоне! Мы отказываемся от них!
