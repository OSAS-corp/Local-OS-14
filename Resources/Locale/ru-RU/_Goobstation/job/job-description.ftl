...
job-description-operations-officer = Отправляйте, инструктируйте и руководите командами экстренного реагирования или другими силами НаноТрейзен. Выпускайте ядерные коды — или нет.
