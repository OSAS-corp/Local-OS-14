...
heretic-ghoul-greeting =
    Ты был вызван в этот мир { $ent }!
    Ты должен помогать им в их пути к Вознесению и защищать их любой ценой.
...
heretic-ghoul-briefing-start =
    Вы были призваны в этот мир благодаря { $ent }!
...
heretic-ghoul-briefing-end =
    ...
    используйте "+m" в чате что-бы соединиться с Мансусом.
