...
traitor-tigercooperative-intro = Вы — фанатик Кооператив "Тигр".
traitor-tigercooperative-goal = Помните учение Хай-лургиксона: сперва убей, потом задавай вопросы!
traitor-tigercooperative-allies = Доверяйте только просвещённым братьям "Тигр". Все остальные должны быть изгнаны из этого мира!
...
traitor-wafflecorporation-roundend = [color=orange]сотрудник Корпорация Ваффель[/color]
...
traitor-neulithivfederationvisionary-intro = Вы — Провидец из Федерации Неулитов
...
traitor-neulithivfederationvisionary-roundend = [color=violet]Провидец из Федерации Неулитов[/color]
