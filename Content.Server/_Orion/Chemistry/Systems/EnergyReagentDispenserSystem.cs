...
namespace Content.Server._Orion.Chemistry.Systems;

/// <summary>
/// Contains all the server-side logic for reagent dispensers.
/// <seealso cref="Components.EnergyReagentDispenserComponent"/>
/// </summary>
[UsedImplicitly]
public sealed class EnergyReagentDispenserSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<EnergyReagentDispenserComponent, GotEmaggedEvent>(OnEmagged);
