...
public sealed partial class SkillSelector : Control
{
    ...
    private readonly ProtoId<SkillPrototype> _skillId;
    ...
    public SkillSelector(ProtoId<SkillPrototype> skillId, int currentLevel, int[] costs, Color skillColor, int defaultLevel = 1, bool upgradeOnly = false)
    {
        ...
        SkillNameLabel.Text = Loc.GetString($"skill-{_skillId.ToString().ToLower()}");
        SkillDescriptionLabel.Text = Loc.GetString($"skill-{_skillId.ToString().ToLower()}-desc");
    ...
    {
        SetButtonTooltip(Level1Button, 1);
        SetButtonTooltip(Level2Button, 2);
        SetButtonTooltip(Level3Button, 3);
        SetButtonTooltip(Level4Button, 4);
    }

    private void SetButtonTooltip(Button button, int level)
    {
        button.ToolTip = Loc.GetString($"skill-{_skillId.ToString().ToLower()}-level-{level}-desc");
    }
    ...
    public void UpdateAvailability(int unspentPoints, SharedSkillsSystem skillsSystem)
    {
        ...
        for (var targetLevel = 1; targetLevel <= 4; targetLevel++)
        {
    ...
    private void UpdateLevelButtons()
    {
        ...
        Level1Button.StyleClasses.Add(StyleBase.ButtonOpenRight);
        Level2Button.StyleClasses.Add(StyleBase.ButtonOpenBoth);
        Level3Button.StyleClasses.Add(StyleBase.ButtonOpenBoth);
        Level4Button.StyleClasses.Add(StyleBase.ButtonOpenLeft);
    }
