...
public sealed partial class SkillsWindow : FancyWindow
{
    ...
    public SkillsWindow(string jobId, Dictionary<byte, int> currentSkills, Dictionary<byte, int> defaultSkills, int totalPoints, bool upgradeOnly = false)
    {
